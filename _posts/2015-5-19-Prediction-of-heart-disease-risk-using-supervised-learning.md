...
I have also hosted an interactive application (weblink: [weblink_to_interactive_slider_app](http://54.149.139.144/)) that computes heart disease risk using a slightly more simplified model on the remote machine on Amazon Web Services. 
