...
My simplified version of interactive intelligent heart disease risk predictor based on d3 can provide heart disease risk prediction based on a person's age, family history, sex, smoking habits etc. The D3 visualization is available at this link (<iframe src="{{ site.baseurl }}/images/indextest4.html" marginwidth="50" marginheight="50" scrolling="yes"></iframe>).
